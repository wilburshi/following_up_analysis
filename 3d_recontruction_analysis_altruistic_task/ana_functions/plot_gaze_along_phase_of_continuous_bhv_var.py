...
def plot_gaze_along_phase_of_continuous_bhv_var(fig_savepath, savefig, animal1, animal2, session_start_time, succpulls_ornot, time_point_pull1, time_point_pull2, oneway_gaze1, oneway_gaze2, mutual_gaze1, mutual_gaze2, animalnames_videotrack, output_look_ornot, output_allvectors, output_allangles, output_key_locations, doActvePeri, doGazeStart):
    ...
    if doActvePeri:
        ...
        nallframes = np.shape(output_allangles['face_eye_angle_all_Anipose']['dodson'])[0]
