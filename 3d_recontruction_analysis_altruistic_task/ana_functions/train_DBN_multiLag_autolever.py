...
########################################
def train_DBN_multiLag_create_df_only(totalsess_time, session_start_time, temp_resolu, time_point_pull1, time_point_pull2, oneway_gaze1, oneway_gaze2, mutual_gaze1, mutual_gaze2, time_point_otherlever1, time_point_otherlever2):
...
# totalsess_time: the time (s) of the total session
    ...
    total_time = int(np.floor((totalsess_time)/temp_resolu))
    ...
    time_point_levergaze1_round = np.floor(pd.Series(time_point_otherlever1)/temp_resolu).reset_index(drop = True).astype(int)
    time_point_levergaze2_round = np.floor(pd.Series(time_point_otherlever2)/temp_resolu).reset_index(drop = True).astype(int)
    ...
    # clean up dataframe
    data = np.concatenate((pull1_t0,pull2_t0,owgaze1_t0,owgaze2_t0,lvgaze1_t0,lvgaze2_t0,pull1_t1,pull2_t1,owgaze1_t1,owgaze2_t1,lvgaze1_t1,lvgaze2_t1,pull1_t2,pull2_t2,owgaze1_t2,owgaze2_t2,lvgaze1_t2,lvgaze2_t2,pull1_t3,pull2_t3,owgaze1_t3,owgaze2_t3,lvgaze1_t3,lvgaze2_t3,),axis = 1)
    colnames = ["pull1_t0","pull2_t0","owgaze1_t0","owgaze2_t0","lvgaze1_t0","lvgaze2_t0","pull1_t1","pull2_t1","owgaze1_t1","owgaze2_t1","lvgaze1_t1","lvgaze2_t1","pull1_t2","pull2_t2","owgaze1_t2","owgaze2_t2","lvgaze1_t2","lvgaze2_t2","pull1_t3","pull2_t3","owgaze1_t3","owgaze2_t3","lvgaze1_t3","lvgaze2_t3"]
    eventnames = ["pull1","pull2","owgaze1","owgaze2","lvgaze1","lvgaze2"]
...
# totalsess_time: the time (s) of the total session
    ...
    # clean up dataframe
    data = np.concatenate((pull1_t0,pull2_t0,owgaze1_t0,owgaze2_t0,pull1_t1,pull2_t1,owgaze1_t1,owgaze2_t1,pull1_t2,pull2_t2,owgaze1_t2,owgaze2_t2,pull1_t3,pull2_t3,owgaze1_t3,owgaze2_t3),axis = 1)
    colnames = ["pull1_t0","pull2_t0","owgaze1_t0","owgaze2_t0","pull1_t1","pull2_t1","owgaze1_t1","owgaze2_t1","pull1_t2","pull2_t2","owgaze1_t2","owgaze2_t2","pull1_t3","pull2_t3","owgaze1_t3","owgaze2_t3"]
...
# totalsess_time: the time (s) of the total session
    ...
    total_time = int((totalsess_time)/temp_resolu)
    time_point_pull1_round = np.floor(time_point_pull1/temp_resolu).reset_index(drop = True).astype(int)
    time_point_pull1_round = time_point_pull1_round[time_point_pull1_round<total_time]
    time_point_pull2_round  = np.floor(time_point_pull2/temp_resolu).reset_index(drop = True).astype(int)
    time_point_pull2_round = time_point_pull2_round[time_point_pull2_round<total_time]
