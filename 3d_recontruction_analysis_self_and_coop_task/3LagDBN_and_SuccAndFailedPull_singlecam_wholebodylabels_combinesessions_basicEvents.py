...
if not mergetempRos:
    ...
    with open(data_saved_subfolder+'//DBN_input_data_alltypes_'+animal1_fixedorder[0]+animal2_fixedorder[0]+'_mergeTempsReSo.pkl', 'rb') as f:
        DBN_input_data_alltypes = pickle.load(f)
plt.plot(DBN_input_data_alltypes['succpull']['no-vision']['pull1_t0'].reset_index(drop=True))       
plt.plot(DBN_input_data_alltypes['failedpull']['no-vision']['pull1_t0'].reset_index(drop=True))
...
if not mergetempRos:
    ...
    with open(data_saved_subfolder+'//DBN_input_data_alltypes_'+animal1_fixedorder[0]+animal2_fixedorder[0]+'_mergeTempsReSo.pkl', 'rb') as f:
        DBN_input_data_alltypes = pickle.load(f)
plt.plot(DBN_input_data_alltypes['no-vision']['pull1_t0'].reset_index(drop=True))
...
animal2_fixedorders = ['sparkle','scorch','kanga','kannga']
