...
# consider the within layer edges
...
def graph_to_matrix(edges,nFromNodes,nToNodes,eventnames):
    ...
    row = 0
    for from_timeslice in ['t0','t1','t2','t3']:
...
########################################
def train_DBN_multiLag_create_df_only(totalsess_time, session_start_time, temp_resolu, time_point_pull1, time_point_pull2, oneway_gaze1, oneway_gaze2, mutual_gaze1, mutual_gaze2):
