...
def find_socialgaze_timepoint_singlecam_wholebody(bodyparts_locs_camN, lever_loc_both, tube_loc_both, considerlevertube, considertubeonly,sqr_thres_tubelever,sqr_thres_face,sqr_thres_body):
    ...
    output_look_ornot = {"look_at_other_or_not_merge":look_at_other_or_not_merge,"look_at_otherface_or_not_merge":look_at_otherface_or_not_merge,"look_at_tube_or_not_merge":look_at_tube_or_not_merge,"look_at_lever_or_not_merge":look_at_lever_or_not_merge}
