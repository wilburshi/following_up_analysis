...
def get_continuous_bhv_var_for_neuralGLM_fitting_BasisKernelsForContVaris(animal1, animal2, animalnames_videotrack, session_start_time, starttime, endtime, stg_twins, time_point_pull1, time_point_pull2, time_point_juice1, time_point_juice2, time_point_pulls_succfail, oneway_gaze1, oneway_gaze2, mutual_gaze1, mutual_gaze2, gaze_thresold, output_look_ornot,  output_allvectors, output_allangles, output_key_locations, spike_clusters_data, spike_time_data, spike_channels_data):
...
def neuralGLM_fitting_BasisKernelsForContVaris(animal1, animal2, data_summary_names, data_summary, spiketrain_summary, bhvvaris_toGLM, nbootstraps, traintestperc, trig_twin, dospikehist, spikehist_twin, doplots, date_tgt, savefig, save_path, dostrategies, donullshuffle):
