#  function - get the key continuous behavioral variables and then project them to smaller PC space
...
def get_data_for_singlecam_conBhv_from_highDimension_to_PCspace(gausKernelsize, fps, animal1, animal2, animalnames_videotrack, session_start_time, time_point_pull1, time_point_pull2, time_point_juice1, time_point_juice2, oneway_gaze1, oneway_gaze2, mutual_gaze1, mutual_gaze2, output_look_ornot, output_allvectors, output_allangles, output_key_locations):
    ...
    data_summary_twoanimals = dict.fromkeys([animal1,animal2])
    ...
    for ianimal in np.arange(0,2,1): 
        ...
        #
        if ianimal == 0:
            data_summary_twoanimals[animal1] = data_summary
        elif ianimal == 1:
            data_summary_twoanimals[animal2] = data_summary
            
            

    return data_summary_twoanimals, data_summary_names
