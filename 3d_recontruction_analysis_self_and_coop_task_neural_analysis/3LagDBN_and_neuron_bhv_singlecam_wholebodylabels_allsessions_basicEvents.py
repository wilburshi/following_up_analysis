...
if animal1_fixedorder[0] == 'dannon':
    owgaze1_num_all_dates = owgaze1_num_all_dates[0:13]
    owgaze2_num_all_dates = owgaze2_num_all_dates[0:13]
    mtgaze1_num_all_dates = mtgaze1_num_all_dates[0:13]
    mtgaze2_num_all_dates = mtgaze2_num_all_dates[0:13]
    pull1_num_all_dates = pull1_num_all_dates[0:13]
    pull2_num_all_dates = pull2_num_all_dates[0:13]
